...
/// <see cref="Core.Builders.BuilderBase{T,TSelf}.Get"/> in Uno. Calling <c>Get()</c>
...
{
    private readonly UnoInput _input = new(inputTextBox);
    private readonly UnoOutput _output = new(promptBlock, errorBlock);
