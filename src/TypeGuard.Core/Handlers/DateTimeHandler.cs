...
/// <summary>
/// An input handler that prompts for and validates DateTime input according to a specified format.
/// </summary>
...
) : HandlerBase<DateTime>(inputProvider, outputProvider, prompt)
{
