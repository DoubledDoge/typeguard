...
/// <summary>
///     A fluent builder for constructing and configuring a numeric input handler with validation
///     rules.
///     Each <c>With*</c> method accumulates a rule onto the internal validator while the rules are
///     evaluated
///     in the order they are added.
///     Supports int, long, float, double, decimal, byte, short, sbyte, ushort, uint, ulong, nint,
///     nuint, and Half.
/// </summary>
/// <typeparam name="T">
///     The numeric type to validate. Must implement <see cref="INumber{T}" /> and
///     <see cref="IMinMaxValue{T}" />.
/// </typeparam>
...
///     Defaults to constructing a standard <see cref="NumericHandler{T}" /> from the provided
///     providers.
/// </param>
	...
	where T : INumber<T>, IMinMaxValue<T>
{
	...
	/// <summary>
	///     Adds a validation rule that ensures the numeric value is non-negative (greater than or equal to
	///     zero).
	/// </summary>
	/// <param name="customMessage">An optional custom error message.</param>
	/// <returns>The current builder instance for method chaining.</returns>
	...
	/// <summary>
	///     Adds a validation rule that ensures the numeric value is greater than or equal to the specified
	///     minimum.
	/// </summary>
	/// <param name="min">The minimum allowed value (inclusive).</param>
	/// <param name="customMessage">An optional custom error message.</param>
	...
	/// <summary>
	///     Adds a validation rule that ensures the numeric value is less than or equal to the specified
	///     maximum.
	/// </summary>
	/// <param name="max">The maximum allowed value (inclusive).</param>
	/// <param name="customMessage">An optional custom error message.</param>
	...
	///     The function that determines whether a numeric value is valid. Cannot be
	///     null.
	/// </param>
...
///     <see cref="InvalidOperationException" />. Create a new <see cref="IntegerInputBuilder{T}" />
///     instance
///     if you need to reconfigure and re-prompt.
/// </remarks>
/// <typeparam name="T">
///     The integer type to validate. Must implement <see cref="IBinaryInteger{T}" />
///     and <see cref="IMinMaxValue{T}" />.
/// </typeparam>
/// <param name="prompt">The prompt message to display when requesting user input.</param>
/// <param name="inputProvider">The provider responsible for reading user input.</param>
/// <param name="outputProvider">The provider responsible for displaying output messages.</param>
	...
	where T : IBinaryInteger<T>, IMinMaxValue<T>
{
	...
	/// <summary>
	///     Adds a validation rule that ensures the integer value is not a multiple of the specified
	///     factor.
	/// </summary>
	...
	///     The Luhn algorithm is commonly used to validate credit card numbers, IMEI numbers, and other
