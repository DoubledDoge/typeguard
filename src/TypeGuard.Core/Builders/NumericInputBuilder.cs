    ...
    where T : INumber<T>, IMinMaxValue<T>
{
    ...
    public NumericInputBuilder<T> WithRange(T min, T max, string? customMessage = null)
    {
        return min > max
            ...
            : this.AddRule(new RangeRule<T>(min, max, customMessage));
    }
    ...
    public NumericInputBuilder<T> WithPositive(string? customMessage = null) =>
        this.AddRule(new PositiveRule<T>(customMessage));
    ...
    public NumericInputBuilder<T> WithNonNegative(string? customMessage = null) =>
        this.AddRule(new NonNegativeRule<T>(customMessage));
    ...
    public NumericInputBuilder<T> WithNegative(string? customMessage = null) =>
        this.AddRule(new NegativeRule<T>(customMessage));
    ...
    public NumericInputBuilder<T> WithMinimum(T min, string? customMessage = null) =>
        this.AddRule(new MinimumRule<T>(min, customMessage));
    ...
    public NumericInputBuilder<T> WithCustomRule(Func<T, bool> predicate, string errorMessage)
    {
        ...
        return this.AddRule(new CustomRule<T>(predicate, errorMessage));
    }
}
    ...
    where T : IBinaryInteger<T>, IMinMaxValue<T>
{
    ...
    {
        this.AddRule(new EvenRule<T>(customMessage));
        return this;
    }
    ...
    {
        this.AddRule(new OddRule<T>(customMessage));
        return this;
    }
    ...
    {
        return T.IsZero(factor)
            ? throw new ArgumentException("factor cannot be zero.", nameof(factor))
            : (IntegerInputBuilder<T>)this.AddRule(new MultipleOfRule<T>(factor, customMessage));
    }
    ...
    public IntegerInputBuilder<T> WithNotMultipleOf(T factor, string? customMessage = null)
    {
        return T.IsZero(factor)
            ? throw new ArgumentException("factor cannot be zero.", nameof(factor))
            : (IntegerInputBuilder<T>)this.AddRule(new NotMultipleOfRule<T>(factor, customMessage));
    }
    ...
    {
        this.AddRule(new LuhnRule<T>(customMessage));
        return this;
    }
}
