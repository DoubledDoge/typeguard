    ...
    )
{
    ...
    public TimeOnlyInputBuilder WithRange(TimeOnly min, TimeOnly max, string? customMessage = null)
    {
        return min > max
    ...
    /// <exception cref="InvalidOperationException">Thrown if the builder has been frozen.</exception>
    public TimeOnlyInputBuilder WithTimeIncrement(TimeSpan increment, string? customMessage = null)
    {
