    ...
    )
{
    ...
    public GuidInputBuilder WithNonEmpty(string? customMessage = null) =>
        this.AddRule(new NonEmptyGuidRule(customMessage));
    ...
    {
        return version is < 1 or > 5
            ? throw new ArgumentOutOfRangeException(
                nameof(version),
                version,
                "version must be between 1 and 5."
            )
            : this.AddRule(new GuidVersionRule(version, customMessage));
    }
    ...
    )
    {
        ...
        return !enumerable.Any()
            ...
            : this.AddRule(new ExcludedGuidRule(enumerable, customMessage));
    }
    ...
    )
    {
        ...
        return !enumerable.Any()
            ...
            : this.AddRule(new AllowedGuidRule(enumerable, customMessage));
    }
    ...
    public GuidInputBuilder WithCustomRule(Func<Guid, bool> predicate, string errorMessage)
    {
        ...
        return this.AddRule(new CustomRule<Guid>(predicate, errorMessage));
    }
}
