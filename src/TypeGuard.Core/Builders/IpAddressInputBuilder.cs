	...
	)
{
	...
	)
	{
		...
		return prefixLength is < 0 or > 128
			...
			: AddRule(new SubnetRule(network, prefixLength, customMessage));
	}
	...
	)
	{
		...
		return !enumerable.Any()
			...
			: AddRule(new AllowedIpAddressesRule(enumerable, customMessage));
	}
	...
	)
	{
		...
		return !enumerable.Any()
			...
			: AddRule(new BlockedIpAddressesRule(enumerable, customMessage));
	}
	...
	)
	{
		...
		return AddRule(new CustomRule<IPAddress>(predicate, errorMessage));
	}
}
