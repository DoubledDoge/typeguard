...
/// <summary>
///     A fluent builder for constructing and configuring a DateOnly input handler with validation
///     rules.
...
/// <param name="format">
///     The expected date format string. If null, any valid DateOnly format is
///     accepted.
/// </param>
	...
	)
{
	...
	public DateOnlyInputBuilder WithRange(
		DateOnly min,
		DateOnly max,
		...
		min > max
			...
			: AddRule(new RangeRule<DateOnly>(min, max, customMessage));
	...
	public DateOnlyInputBuilder WithFutureDate(string? customMessage = null) =>
		AddRule(FutureDateRule.ForDateOnly(customMessage));
	...
	public DateOnlyInputBuilder WithPastDate(string? customMessage = null) =>
		AddRule(PastDateRule.ForDateOnly(customMessage));
	...
	public DateOnlyInputBuilder WithTodayDate(string? customMessage = null) =>
		AddRule(TodayRule.ForDateOnly(customMessage));
	...
	public DateOnlyInputBuilder WithNotTodayDate(string? customMessage = null) =>
		AddRule(NotTodayRule.ForDateOnly(customMessage));
	...
	public DateOnlyInputBuilder WithWeekday(string? customMessage = null) =>
		AddRule(WeekdayRule.ForDateOnly(customMessage));
	...
	public DateOnlyInputBuilder WithWeekend(string? customMessage = null) =>
		AddRule(WeekendRule.ForDateOnly(customMessage));
	...
	public DateOnlyInputBuilder WithDayOfWeek(DayOfWeek dayOfWeek, string? customMessage = null) =>
		AddRule(DayOfWeekRule.ForDateOnly(dayOfWeek, customMessage));
	...
	public DateOnlyInputBuilder WithinDays(int days, string? customMessage = null) =>
		days <= 0
			...
			: AddRule(WithinDaysRule.ForDateOnly(days, customMessage));
	...
	public DateOnlyInputBuilder WithYear(int year, string? customMessage = null) =>
		AddRule(YearRule.ForDateOnly(year, customMessage));
	...
	public DateOnlyInputBuilder WithLeapYear(string? customMessage = null) =>
		AddRule(LeapYearRule.ForDateOnly(customMessage));
	...
	public DateOnlyInputBuilder WithMonth(int month, string? customMessage = null) =>
		AddRule(MonthRule.ForDateOnly(month, customMessage));

	/// <summary>
	///     Adds a custom validation rule to the handler.
	/// </summary>
	/// <param name="predicate">
	///     The function that determines whether a DateOnly value is valid. Cannot be
	///     null.
	/// </param>
	...
	public DateOnlyInputBuilder WithCustomRule(Func<DateOnly, bool> predicate, string errorMessage)
	{
		...
		return AddRule(new CustomRule<DateOnly>(predicate, errorMessage));
	}
}
