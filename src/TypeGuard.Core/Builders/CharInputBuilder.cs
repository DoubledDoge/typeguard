...
/// An optional factory for creating the internal <see cref="CharValidator"/>.
/// Defaults to constructing a standard <see cref="CharValidator"/> from the provided providers.
/// </param>
public class CharInputBuilder(
    string prompt,
    IInputProvider inputProvider,
    IOutputProvider outputProvider,
    Func<string, IInputProvider, IOutputProvider, CharValidator>? validatorFactory = null
)
    : BuilderBase<char, CharInputBuilder>(
        (validatorFactory ?? ((p, i, o) => new CharValidator(i, o, p)))(
