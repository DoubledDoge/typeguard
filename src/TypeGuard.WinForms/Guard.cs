...
public class Guard(Control inputControl, Label promptLabel, Label errorLabel)
{
    private readonly WinFormsInput _input = new(inputControl);
    private readonly WinFormsOutput _output = new(promptLabel, errorLabel);
