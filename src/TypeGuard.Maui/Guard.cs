...
public class Guard(Entry entry, Label promptLabel, Label errorLabel, Button? submitButton = null)
{
    ...
    /// <summary>Creates a builder for handling <see cref="int"/> input.</summary>
    /// <param name="prompt">The prompt message to display to the user.</param>
    public IntegerInputBuilder<int> Int(string prompt) => new(prompt, _input, _output);

    /// <summary>Creates a builder for handling <see cref="double"/> input.</summary>
    /// <param name="prompt">The prompt message to display to the user.</param>
    public NumericInputBuilder<double> Double(string prompt) => new(prompt, _input, _output);

    /// <summary>Creates a builder for handling <see cref="decimal"/> input.</summary>
    /// <param name="prompt">The prompt message to display to the user.</param>
    ...
    /// <summary>Creates a builder for handling <see cref="string"/> input.</summary>
    /// <param name="prompt">The prompt message to display to the user.</param>
    public StringInputBuilder String(string prompt) => new(prompt, _input, _output);

    /// <summary>Creates a builder for handling <see cref="char"/> input.</summary>
    /// <param name="prompt">The prompt message to display to the user.</param>
    public CharInputBuilder Char(string prompt) => new(prompt, _input, _output);

    /// <summary>Creates a builder for handling <see cref="DateOnly"/> input.</summary>
    /// <param name="prompt">The prompt message to display to the user.</param>
    ...
    /// <summary>Creates a builder for handling <see cref="DateTime"/> input.</summary>
    /// <param name="prompt">The prompt message to display to the user.</param>
    ...
    /// <summary>Creates a builder for handling <see cref="TimeOnly"/> input.</summary>
    /// <param name="prompt">The prompt message to display to the user.</param>
    ...
    /// <summary>Creates a builder for handling <see cref="TimeSpan"/> input.</summary>
    /// <param name="prompt">The prompt message to display to the user.</param>
    ...
    /// <summary>Creates a builder for handling <see cref="System.Guid"/> input.</summary>
    /// <param name="prompt">The prompt message to display to the user.</param>
    public GuidInputBuilder Guid(string prompt) => new(prompt, _input, _output);

    /// <summary>Creates a builder for handling <see cref="IPAddress"/> input.</summary>
    /// <param name="prompt">The prompt message to display to the user.</param>
    public IpAddressInputBuilder IpAddress(string prompt) => new(prompt, _input, _output);

    /// <summary>Creates a builder for handling <see cref="Uri"/> input.</summary>
    /// <param name="prompt">The prompt message to display to the user.</param>
    ...
    /// <summary>Creates a builder for handling enum input of type <typeparamref name="TEnum"/>.</summary>
